...
requisicaomaterial.cod_funcionario,
...
itensrequisicaomaterial.nrrequisicao = requisicaomaterial.nrrequisicao and
itensrequisicaomaterial.datarequisicao_item > to_date('01/01/2023','dd/mm/yyyy') and
itensrequisicaomaterial.data_canc is null and
itensrequisicaomaterial.nr_solicitacao = 0 and
material.cod_unidade <> 'SV' and
itensrequisicaomaterial.dataretirada is null and
requisicaomaterial.cod_funcionario not in (1560, 1207, 3941, 1476)
